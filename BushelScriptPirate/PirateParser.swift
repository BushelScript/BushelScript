...
public final class PirateParser: BushelLanguage.SourceParser {
    ...
    public init(source: String) {
        ...
        lexicon.push(name: TermName("argh BushelScript"))
    }
    
    private lazy var mathDictionary: [TermDescriptor] = [
        PropertyDescriptor(.math_pi, name: TermName("argh pi")),
        PropertyDescriptor(.math_e, name: TermName("argh e")),
        
        CommandDescriptor(.math_abs, name: TermName("argh absolute value"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_abs, name: TermName("argh abs"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_sqrt, name: TermName("argh square root"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_sqrt, name: TermName("argh sqrt"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_cbrt, name: TermName("argh cube root"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_cbrt, name: TermName("argh cubed root"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_cbrt, name: TermName("argh cbrt"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_square, name: TermName("argh square"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_square, name: TermName("argh squared"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_cube, name: TermName("argh cube"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_cube, name: TermName("argh cubed"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of"))
        ]),
        CommandDescriptor(.math_pow, name: TermName("argh power"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of")),
            ParameterDescriptor(.math_pow_exponent, name: TermName("argh to the"))
        ]),
        CommandDescriptor(.math_pow, name: TermName("argh pow"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh of")),
            ParameterDescriptor(.math_pow_exponent, name: TermName("argh to the"))
        ]),
    ]
    ...
    private lazy var guiDictionary: [TermDescriptor] = [
        CommandDescriptor(.gui_notification, name: TermName("argh notification"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh message")),
            ParameterDescriptor(.gui_notification_title, name: TermName("argh title")),
            ParameterDescriptor(.gui_notification_subtitle, name: TermName("argh subtitle")),
            ParameterDescriptor(.gui_notification_sound, name: TermName("argh sound"))
        ]),
        CommandDescriptor(.gui_alert, name: TermName("argh alert"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh heading")),
            ParameterDescriptor(.gui_alert_message, name: TermName("argh message")),
            ParameterDescriptor(.gui_alert_kind, name: TermName("argh kind")),
            ParameterDescriptor(.gui_alert_buttons, name: TermName("argh buttons")),
            ParameterDescriptor(.gui_alert_default, name: TermName("argh default")),
            ParameterDescriptor(.gui_alert_cancel, name: TermName("argh cancel")),
            ParameterDescriptor(.gui_alert_timeout, name: TermName("argh timeout")),
        ]),
    ]
    
    private lazy var cliDictionary: [TermDescriptor] = [
        CommandDescriptor(.cli_log, name: TermName("argh log"), parameters: [
            ParameterDescriptor(.direct, name: TermName("argh message"))
        ]),
    ]
    
    public lazy var defaultTerms: [TermDescriptor] = [
        PropertyDescriptor(.properties, name: TermName("argh properties")),
        PropertyDescriptor(.index, name: TermName("argh index")),
        PropertyDescriptor(.name, name: TermName("argh name")),
        PropertyDescriptor(.id, name: TermName("argh id")),
        
        ConstantDescriptor(.true, name: TermName("argh true")),
        ConstantDescriptor(.false, name: TermName("argh false")),
        
        TypeDescriptor(TypeUID.list, name: TermName("argh list")),
        PropertyDescriptor(.sequence_length, name: TermName("argh length")),
        PropertyDescriptor(.sequence_reverse, name: TermName("argh reverse")),
        PropertyDescriptor(.sequence_tail, name: TermName("argh tail")),
        
        TypeDescriptor(.item, name: TermName("argh item")),
        TypeDescriptor(.record, name: TermName("argh record")),
        TypeDescriptor(.string, name: TermName("argh string")),
        TypeDescriptor(.character, name: TermName("argh character")),
        TypeDescriptor(.integer, name: TermName("argh integer")),
        TypeDescriptor(.real, name: TermName("argh real")),
        TypeDescriptor(.window, name: TermName("argh window")),
        TypeDescriptor(.document, name: TermName("argh document")),
        TypeDescriptor(.file, name: TermName("argh file")),
        TypeDescriptor(.alias, name: TermName("argh alias")),
        TypeDescriptor(.application, name: TermName("argh application")),
        
        CommandDescriptor(.run, name: TermName("argh run"), parameters: [
        ]),
        CommandDescriptor(.reopen, name: TermName("argh reopen"), parameters: [
        ]),
        CommandDescriptor(CommandUID.open, name: TermName("argh open"), parameters: [
            ParameterDescriptor(.open_searchText, name: TermName("argh search text"))
        ]),
        CommandDescriptor(.print, name: TermName("argh print"), parameters: [
        ]),
        CommandDescriptor(.quit, name: TermName("argh quit"), parameters: [
        ]),
        
        DictionaryDescriptor("bushel.dictionary.math", name: TermName("argh Math"), contents: mathDictionary),
        DictionaryDescriptor("bushel.dictionary.sequence", name: TermName("argh Sequence"), contents: sequenceDictionary),
        DictionaryDescriptor("bushel.dictionary.gui", name: TermName("argh GUI"), contents: guiDictionary),
    ...
    public let binaryOperators: [TermName : BinaryOperation] = [
        ...
        TermName("argh *"): .multiply,
        TermName("argh /"): .divide,
        TermName("argh &"): .concatenate
    ]
    
    public lazy var keywords: [TermName : KeywordHandler] = [
        TermName("argh ("): handleOpenParenthesis,
        TermName("argh {"): handleOpenBrace,
        TermName("argh on"): handleFunctionStart,
        TermName("argh to"): handleFunctionStart,
        TermName("argh if"): handleIf,
        TermName("argh repeat"): handleRepeat,
        TermName("argh repeating"): handleRepeat,
        TermName("argh tell"): handleTell,
        TermName("argh end"): {
            .end
        },
        TermName("argh end if"): {
            // TODO: Check we're ending an ‘if’-block
            .end
        },
        TermName("argh end tell"): {
            // TODO: Check we're ending a ‘tell’-block
            .end
        },
        TermName("argh let"): handleLet,
        TermName("argh return"): {
            .return_(try self.parsePrimary())
        },
        TermName("argh use application"): handleUseApplication,
        TermName("argh use app"): handleUseApplication,
        TermName("argh that"): {
            .that
        },
        TermName("argh it"): {
