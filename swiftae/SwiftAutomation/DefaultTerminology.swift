...
public class DefaultTerminology: ApplicationTerminology {
    ...
    private static let _GURL = try! FourCharCode(fourByteString: "GURL")
    private static let _WIND = try! FourCharCode(fourByteString: "WIND")
    private static let _pALL = try! FourCharCode(fourByteString: "pALL")
}
