...
{
    /* OSADictionaryView * */ NSView *dictionaryView;
    NSSearchField *searchField;
    /* OSADictionaryControllerPrivate * */ id _private;
}

@property(retain) NSSearchField *searchField;
- (void)setDictionaryView:(NSView *)arg1;
- (NSView *)dictionaryView;
- (void)setDictionary:(OSADictionary *)arg1;
- (OSADictionary *)dictionary;
